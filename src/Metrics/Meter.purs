...
foreign import record' :: forall a m d. Instrument Synchronous a m d -> d -> Effect Unit

foreign import add :: forall m d. BoundInstrument Synchronous Additive m d -> d -> Effect Unit
foreign import add' :: forall m d. Instrument Synchronous Additive m d -> d -> Effect Unit
