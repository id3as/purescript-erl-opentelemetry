...
import OpenTelemetry.Metrics (Additive, Additivity, Asynchronous, BoundInstrument, Instrument, InstrumentDefinition, InstrumentDescription(..), InstrumentName(..), InstrumentUnit(..), Label, Meter, MeterName(..), MeterVersion(..), Monotonic, Monotonicity, NonAdditive, NonMonotonic, ObserverResult, Synchronicity, Synchronous, getDefaultMeter, getMeter, getMeter', label, registerApplicationMeter, registerMeter, setDefaultMeter) as Metrics
